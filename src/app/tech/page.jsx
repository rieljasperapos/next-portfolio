        ...
        <section className="grid p-4 pb-16 sm:pb-22 sm:pr-14 sm:pl-14 xl:ml-64 xl:mr-64 h-full mt-8">
            <div>
                <div className="flex flex-wrap w-auto justify-center lg:pt-12 sm:pr-12">
                    <div className="group">
                        <Image src={C} alt="C" id="C" className="w-10 h-10 m-4 sm:w-16 sm:h-16 hover:scale-105 hover:animate-bounce transition-transform duration-300 ease-in"></Image>
                        <p className=" font-mono text-center sm:opacity-0 group-hover:opacity-100 transition-opacity ease-in duration-200">C</p>
                    </div>
                    <div className="group">
                        <Image src={Java} alt='Java' id="Java" className="w-10 h-10 m-4 sm:w-16 sm:h-16 hover:scale-105 hover:animate-bounce transition-transform duration-300 ease-in"></Image>
                        <p className=" font-mono text-center sm:opacity-0 group-hover:opacity-100 transition-opacity ease-in duration-200">Java</p>
                    </div>
                    <div className="group">
                        <Image src={Javascript} alt='Javascript' id="Javascript" className="w-10 h-10 m-4 sm:w-16 sm:h-16 hover:scale-105 hover:animate-bounce transition-transform duration-300 ease-in"></Image>
                    ...
                    <div className="group">
                        <Image src={react} alt='react' id="react" className="w-12 h-10 m-4 sm:w-20 sm:h-16 hover:scale-105 hover:animate-bounce transition-transform duration-300 ease-in"></Image>
                        <p className=" font-mono text-center sm:opacity-0 group-hover:opacity-100 transition-opacity ease-in duration-200">React</p>
                    </div>
                    <div className="group">
                        <Image src={Tailwind} alt='tailwind' id="tailwind" className="w-10 h-10 m-4 sm:w-16 sm:h-16 hover:scale-105 hover:animate-bounce transition-transform duration-300 ease-in"></Image>
                    ...
                    <div className="group">
                        <Image src={Css} alt='CSS' id="CSS" className="w-10 h-10 m-4 sm:w-16 sm:h-16 hover:scale-105 hover:animate-bounce transition-transform duration-300 ease-in"></Image>
                        <p className=" font-mono text-center sm:opacity-0 group-hover:opacity-100 transition-opacity ease-in duration-200">Css</p>
                    </div>
                    <div className="group">
                        <Image src={Bootstrap} alt='Bootstrap' id="Bootstrap" className="w-10 h-10 m-4 sm:w-16 sm:h-16 hover:scale-105 hover:animate-bounce transition-transform duration-300 ease-in"></Image>
                    ...
                    <div className="group">
                        <Image src={Html} alt='Html' id="Html" className="w-10 h-10 m-4 sm:w-16 sm:h-16 hover:scale-105 hover:animate-bounce transition-transform duration-300 ease-in"></Image>
                        <p className=" font-mono text-center sm:opacity-0 group-hover:opacity-100 transition-opacity ease-in duration-200">Html</p>
                    </div>
                    <div className="group">
                        <Image src={Php} alt='Php' id="Php" className="w-10 h-10 m-4 sm:w-16 sm:h-16 hover:scale-105 hover:animate-bounce transition-transform duration-300 ease-in"></Image>
