...
function Header() {
    ...
    return (
        ...
        <div className="flex align-center justify-between pl-4 pr-4 shadow-sm">
            ...
            {isMobileMenuOpen && ( // sm:hidden absolute bottom-0 left-0 bg-gray-800 text-white font-sans p-4
                <ul className="sm:hidden absolute right-4 top-16 bg-gray-800 text-white font-sans">
                    <li>
                        <Link
                            href="/"
                            spy={true}
            ...
            <ul className="hidden sm:flex sm:p-4 text-lg">
                ...
                <div className="sm:hidden cursor-pointer p-4" onClick={toggleMobileMenu}>
                    <svg
                        className="w-6 h-6"
                        fill="none"
                        stroke="currentColor"
